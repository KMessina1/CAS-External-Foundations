...
public func simPrintDetails(errorMsg:String = "",file:String = #file,function:String = #function,line:Int = #line,col:Int = #column) -> String {
    var txt:String = "\n└─➤Called by:"
...
public func simPrintDB<Database>(
    type:simPrintDBType,
