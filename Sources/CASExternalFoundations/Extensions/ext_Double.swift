...
public extension Double {
    var dashesIfZero: String { self.isZero ? dashesTxt : String(self) }
    ...
    func asDec(_ decimalPlaces: Int = 0, dashesIfZero: Bool = false) -> String {
        let formatter:NumberFormatter! = NumberFormatter()
            formatter.locale = Locale.current
            formatter.numberStyle = .decimal
            formatter.groupingSeparator = Locale.current.groupingSeparator ?? ","
    ...
    func decPts(_ decimalPlaces:Int=0,minPlaces:Int=0,negPrefix:String?="-",negSuffix:String?="", dashesIfZero: Bool = false) -> String {
        let formatter:NumberFormatter! = NumberFormatter()
            formatter.locale = Locale.current
            formatter.numberStyle = .decimal
            formatter.groupingSeparator = Locale.current.groupingSeparator ?? ","
    ...
    func formatAsPercent(decimalPlaces:Int?=0,negPrefix:String?="-",negSuffix:String?="", dashesIfZero: Bool = false) -> String {
        let formatter:NumberFormatter! = NumberFormatter()
            formatter.locale = Locale.current
